export const kitchen: any = [
         ...
         },
         {
           ...
           key: "day",
           fields: {
             day: { type: "text", placeholder: "Enter day", required: true },
             month: {
               type: "select",
               placeholder: "Select month",
               required: true
             },
             year: { type: "text", placeholder: "Enter year", required: true }
           },
           dayFirst: true,
           protected: false,
           persistent: true,
         ...
         },
         {
           input: false,
           html:
             "<p><em><strong>Good Morning Guys!!!<br>This is Content component.</strong></em></p> ",
           type: "content",
           conditional: { show: null, when: null, eq: "" },
           key: "mycontent",
           lockKey: true
         ...
         },
         {
           ...
           customClass: "customClass",
           questions: [
             { value: "QueValue", label: "QueLabel" },
             { value: "QueValue1", label: "QueLabel1" },
             { value: "QueValue2", label: "QueLabel2" }
           ],
           values: [
             { value: "AnsValue", label: "AnsLabel" },
             { value: "AnsValue1", label: "AnsLabel1" },
             { value: "AnsValue2", label: "AnsLabel2" },
             { value: "AnsValue3", label: "AnsLabel3" }
           ],
           defaultValue: "",
           protected: false,
           persistent: true,
         ...
         },
         {
           ...
           data: {
             values: [
               { value: "opt1", label: "mango" },
               { value: "opt2", label: "apple" },
               { value: "opt3", label: "pineapple" },
               { value: "opt4", label: "grapes" }
             ],
             json: [
               { label: "one", test: "opt1" },
               { label: "two", test: "opt2" },
               { label: "three", test: "opt3" }
             ],
